...
CREATE TABLE `chitietdonhang` (
  ...
  `id_of_fish` varchar(255) NOT NULL,
  ...
  CONSTRAINT `FKg1wkmh42nbksay553njpdjqq7` FOREIGN KEY (`id_of_fish`) REFERENCES `ca_koi_nhat` (`id_of_fish`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chitietdonhang` VALUES (11,'Asagi_009',1),(11,'Kohaku_054',1),(12,'Tancho_042',1);
...
INSERT INTO `donhang` VALUES (11,'Phường Tân Chánh Hiệp, Quận 12, Tp Hồ Chí Minh.','22-11-2024 21:28:41','2024-11-20 21:29:21','cash',4675000.00,'Nguyễn Alex','0704541242',2),(12,'Phường Nhơn Phú, thành phố Quy Nhơn, tỉnh Bình Định','22-11-2024 21:33:38','2024-11-20 21:34:14','e-wallet',3500000.00,'Nguyễn Văn Hello','0123456787',NULL);
...
CREATE TABLE `gio_hang` (
  ...
  `id_of_fish` varchar(255) DEFAULT NULL,
...
INSERT INTO `gio_hang` VALUES (139,'Showa_039',2700000,'nguyenminhthinh');
...
INSERT INTO `tinh_trang_don_hang` VALUES (11,'Đang xử lý','Đơn hàng đang được xử lý','2024-11-20 21:29:21',17),(11,'Đang vận chuyển','Đơn hàng đang được vận chuyển','2024-11-20 21:29:50',18),(11,'Đã giao hàng','Đã giao hàng','2024-11-20 21:31:15',19),(12,'Đang xử lý','Đơn hàng đang được xử lý','2024-11-20 21:34:14',20);
...
-- Dump completed on 2024-11-21 15:17:55
