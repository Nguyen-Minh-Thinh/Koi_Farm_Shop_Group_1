...
public interface GioHangRepository extends JpaRepository<GioHang, Integer> {
    ...
    @Query(value = "SELECT a.*, b.name_of_fish, b.image, c.caption, c.image FROM gio_hang a LEFT JOIN ca_koi_nhat b ON a.id_of_fish = b.id_of_fish LEFT JOIN thuc_an_cho_ca c ON a.id_of_fish = c.id\n" +
            "WHERE a.tai_khoan_nguoi_dung = :userName", nativeQuery = true)
